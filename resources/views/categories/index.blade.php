...
<body class="bg-gray-50 min-h-screen">
            ...
            <div class="p-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <i class="fas {{ $categorie->icone }} text-custom"></i>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="javascript:void(0);" onclick="openEditModal({{ $categorie }});" class="text-custom hover:text-custom/80 mr-3">
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        ...
                        <select class="mx-2 !rounded-button border-gray-300 text-gray-700 text-sm focus:ring-custom focus:border-custom">
                            <option>10</option>
                            <option>25</option>
                            <option>50</option>
                        </select>
                    ...
                    <nav class="flex items-center space-x-2">
                        <button class="!rounded-button px-3 py-2 border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50">
                            Précédent
                        </button>
                        <button class="!rounded-button px-3 py-2 border border-custom bg-custom text-white text-sm font-medium">
                            1
                        </button>
                        <button class="!rounded-button px-3 py-2 border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50">
                            2
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-4 mt-2">
                            ...
                            <button type="button" class="icon-button" onclick="selecteditIcon('fa-cogs')">
                                <i class="fas fa-cogs"></i>
                            </button>
                            <button type="button" class="icon-button" onclick="selecteditIcon('fa-home')">
                                <i class="fas fa-home"></i>
                            </button>
                            <button type="button" class="icon-button" onclick="selecteditIcon('fa-rocket')">
                                <i class="fas fa-rocket"></i>
                            </button>
                            <button type="button" class="icon-button" onclick="selecteditIcon('fa-heart')">
                                <i class="fas fa-heart"></i>
                            </button>
                        </div>
                        <input type="hidden" name="icone" id="editIcone">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Icône sélectionnée</label>
                        <div id="select-icone-edit" class="text-xl"></div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Description</label>
                        <textarea name="description" required id="editDescription"
    ...
    <script>
        function openEditModal(cat) {
            ...
            let action=document.getElementById('editForm').action = '/categories/' + cat.id;
            document.getElementById('editId').value = cat.id;
            document.getElementById('editNom').value =cat.nom;
            document.getElementById('editIcone').value = cat.icone;
        ...
        function selecteditIcon(iconClass) {
            document.getElementById('editIcone').value = iconClass;
            document.getElementById('select-icone-edit').className = "fas " + iconClass;
        }
    </script>
